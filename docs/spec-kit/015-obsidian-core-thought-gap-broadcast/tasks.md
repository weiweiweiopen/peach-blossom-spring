...
- [x] T001 Define terrain-gap review as candidates, not automatic wiki writes.
- [x] T002 Add `wiki_tool.py terrain-gap-lint` command that writes local review artifacts.
- [x] T003 Add `Review/terrain-gaps` folder contract.
- [x] T004 Extend frontmatter schema for terrain-gap reports and pet question terrain state.
- [x] T005 Extend lint checklist for source-bounded promotion rules.
