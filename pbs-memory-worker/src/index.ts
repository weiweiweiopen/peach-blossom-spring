...
const DOMAIN_ALIASES: Array<[RegExp, string[]]> = [
  ...
  [/bioethic|生命倫理|生物倫理/i, ['bioethics', 'DIY biology', 'bioart', 'BioElectronics', 'BioMaterials', 'Hackteria']],
  ...
  [/open hardware|開放硬體|低成本工具|low-cost/i, ['open hardware', 'low-cost', 'DIY', 'tool', 'Hackteria', 'workshop']],
  [/農業|農場|agricultur|farming|farmbot|precision farming|valldaura/i, ['Green Fab Lab', 'Valldaura', 'FarmBot', 'agriculture', 'farming', 'precision farming', 'digital fabrication']],
  [/材料清單|教學步驟|教學文件|failure notes|失敗筆記|documentation/i, ['documentation', 'material list', 'failure notes', 'tutorial', 'Fabricademy', 'KOBAKANT', 'Hackteria']],
