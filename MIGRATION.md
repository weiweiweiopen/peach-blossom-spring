...
The game does not use the old browser-only JSON snapshot as runtime memory. Public cloud mode calls the PBS memory Worker; local mode calls the local Python server.
