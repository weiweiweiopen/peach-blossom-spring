...
5. Evidence-bound Route: 小誌內容必須根據讀到的 notes/source 生成；先判斷材料能否支持論點，若不能，就輸出可玩的閱讀路徑、限制與查證問題。
...
3. 優先使用 compiled Wiki notes 與 curated bridge/index notes 建立語境，再用 source notes 作為具體場景、事件、概念、作品、社群實踐、方法或觀察；不要因為材料中出現工具，就把文章轉成製作教學。
