...
export interface FinalDocument { id: string; petId: string; tick: number; title: string; mode: FinalDocumentMode; modeLabel: string; body: string; bodyHtml?: string; htmlVariant?: string; references: Array<{ label: string; url: string; anchorText: string }>; reviewLog: FinalDocumentLogEntry[]; sourceExchangeIds: string[]; images?: Array<{ url: string; alt: string; sourceUrl: string; caption: string }>; }
