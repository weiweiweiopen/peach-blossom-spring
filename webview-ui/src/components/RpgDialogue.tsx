...
const npcGuideProfiles: Record<string, NpcGuideProfile> = {
  ...
  'jonathan-minchin': {
    ...
    questions: {
      'zh-TW': ['Open Source Beehives 如何把感測器、蜂群照護和 Green Fab Lab 連起來？', 'Green Fab Lab 為什麼把森林當成實驗室？', '農業機器人可以怎麼服務社群而不是只展示科技？'],
      en: ['How do Open Source Beehives connect sensors, bee care, and Green Fab Lab?', 'Why does Green Fab Lab treat the forest as a laboratory?', 'How can farm robots serve communities instead of only showing technology?'],
      id: ['Bagaimana Open Source Beehives menghubungkan sensor, perawatan lebah, dan Green Fab Lab?', 'Mengapa Green Fab Lab memperlakukan hutan sebagai laboratorium?', 'Bagaimana robot pertanian melayani komunitas, bukan hanya memamerkan teknologi?'],
      de: ['Wie verbinden Open Source Beehives Sensoren, Bienenpflege und Green Fab Lab?', 'Warum behandelt Green Fab Lab den Wald als Labor?', 'Wie können Agrarroboter Communities dienen statt nur Technik zu zeigen?'],
      ja: ['Open Source Beehives はセンサー、蜂の世話、Green Fab Lab をどう結びますか？', 'Green Fab Lab はなぜ森を実験室として扱いますか？', '農業ロボットは技術展示ではなくコミュニティにどう役立ちますか？'],
      th: ['Open Source Beehives เชื่อมเซนเซอร์ การดูแลผึ้ง และ Green Fab Lab อย่างไร?', 'ทำไม Green Fab Lab จึงมองป่าเป็นห้องทดลอง?', 'หุ่นยนต์เกษตรรับใช้ชุมชนแทนการโชว์เทคโนโลยีได้อย่างไร?'],
    },
  },
  'marc-dusseiller': {
    opener: {
