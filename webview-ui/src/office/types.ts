...
export interface PixelMapBackground {
  width: number;
  height: number;
...
export interface OfficeLayout {
  ...
  /** Optional pixel-level backdrop rendered below the walkable tile grid. */
...
export interface Character {
  ...
  /** Optional generated question-pet animations keyed by character direction. */
  spriteAnimationsByDirection?: Partial<Record<Direction, SpriteData[]>>;
  /** Optional upstream image animation frames for question pets. */
  imageSpriteAnimation?: string[];
  /** Draw size in world pixels for image-backed sprites. */
  imageSpriteSize?: number;
  /** Movement speed multiplier, primarily for player sprint. */
  moveSpeedMultiplier?: number;
  /** Keeps the player visually walking between very fast queued sprint steps. */
  walkAnimationHoldTimer?: number;
