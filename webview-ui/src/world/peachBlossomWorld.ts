...
export const tamagotchiNpcPlacements: NpcPlacement[] = [
  ...
  { personaId: 'christian-dils', col: 37, row: 20, zoneId: 'lcd-river', idleBehavior: 'stand' },
  ...
  { personaId: 'rully-shabara', col: 11, row: 19, zoneId: 'lcd-river', idleBehavior: 'boat' },
  { personaId: 'wukir-suryadi', col: 13, row: 19, zoneId: 'lcd-river', idleBehavior: 'stand' },
