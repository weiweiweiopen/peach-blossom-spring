...
export function DaydreamPanel({ onClose }: DaydreamPanelProps) {
  ...
  return (
    <section className="daydream-panel" aria-label="Seed-to-Future panel">
      <div className="daydream-panel-header">
        <div>
          <p className="daydream-kicker">Seed-to-Future</p>
      ...
      <form className="daydream-seed-form" onSubmit={handleSubmit}>
        <label htmlFor="daydream-seed">Input: poem, song, artwork text, curatorial note, or research note</label>
        <textarea
          id="daydream-seed"
          value={seed}
