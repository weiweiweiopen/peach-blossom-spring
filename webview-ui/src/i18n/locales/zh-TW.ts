const zhTW = {
  ...
  home: {
    ...
    description: "這是一個互動寓言維度，許多奇怪的朋友在這裡一起做著奇怪的實驗和音樂，一起煮飯生活著，你無意間闖入這個世界並試圖探索並收集如何建造一個烏托邦的方法和試著記住回到這裡的路...\n\n這個遊戲的本體是一個研究訪談稿\"Non-Governmental Matters\"，該研究採訪了14位獨立科技藝術組織者和藝術家，關於經營社群可持續性的看法。這些受訪者的看法被轉化成遊戲裡可以以自然語言進行交談的 NPC。中央的 PBS Computer 是 LLM wiki query 入口：你可以問桃花源社群問題，得到短答，或把當前問題裝訂成維基小書。電子雞是陪你在桃花源裡閒晃的 Tamagotchi agent。",
  ...
  setup: {
    ...
    creatorLead: "選擇電子雞職業，寫下你的名字，然後生成你的 Tamagotchi agent。",
    petOccupationLabel: "寵物職業",
    petOccupationAria: "選擇寵物職業",
    creatorSubmit: "生成你的 Tamagotchi agent!",
    creatorSubmitAria: "生成你的 Tamagotchi agent",
  },
  dialogue: {
    title: "對話",
    askQuestion: "問我一個問題",
