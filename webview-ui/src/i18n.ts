...
const translations: TranslationTable = {
  'zh-TW': {
    ...
    movementHint: '用方向鍵或 WASD 行走。手機可直接滑動螢幕，角色會跟著手指移動。按住 Shift 可加速。',
  ...
  en: {
    ...
    movementHint: 'Use arrow keys or WASD to move. On mobile, drag on the screen and the character follows your finger. Hold Shift to sprint.',
