export type LanguageCode = "zh-TW" | "en" | "th" | "ja";
...
const translations: TranslationTable = {
  "zh-TW": {
    ...
    loginDescription:
      "這是一個互動寓言維度，許多奇怪的朋友一起在這裡做音樂、做著奇怪的實驗，你無意間發現來到這裡的路，並試著探索並收集如何建造一個烏托邦的方法。請自由的與住在這裡的朋友交談，每一個意見裡都有數不盡的寶藏。但記得你的一舉一動都會影響這個自由世界的發展，或許你會在裡面發現夢境與現實世界耦合的方式。",
  ...
  en: {
    ...
    expeditionTitle:
      "Peach Blossom Spring: Dispatching a Thinking Life Simulator",
  ...
  th: {
    ...
    loginSubtitle:
      "An interactive allegorical dimension of Non-Governmental Matters",
    loginDescription:
      "นี่คือมิติ寓言โต้ตอบ มีเพื่อนแปลก ๆ ทำเพลงและทดลองประหลาดอยู่ร่วมกัน คุณบังเอิญพบทางเข้า จึงสำรวจและเก็บวิธีสร้างยูโทเปีย คุยกับเพื่อน ๆ ที่นี่ได้อย่างอิสระ ทุกความเห็นมีสมบัติซ่อนอยู่ และทุกการกระทำของคุณจะส่งผลต่อโลกเสรีใบนี้ บางทีคุณอาจพบวิธีที่ความฝันและโลกจริงเชื่อมเข้าหากัน",
    createProtagonist: "สร้างตัวละคร",
    createTraveler: "สร้างนักเดินทาง",
    nameLabel: "ชื่อ",
    namePlaceholder: "ใส่ชื่อของคุณ",
    roleLabel: "บทบาทปัจจุบัน",
    rolePlaceholder:
      "Independent researcher, artist, engineer, village summoner...",
    missionLabel: "ฉันต้องการอะไร",
    missionPlaceholder:
      "Describe the wish, need, or future you want this avatar to bring into Peach Blossom Spring.",
    constraintsLabel: "Constraints (optional)",
    constraintsPlaceholder:
      "No corporate dashboard, tiny budget, must be open source, prototype in three months...",
    avatarCollection: "Place Role",
    skillsLabel: "ฉันมีทักษะอะไร",
    skillsPlaceholder:
      "For example: field research, open hardware, curation, community organizing, textiles, coding.",
    enterWorld: "เข้า桃花源",
    sendOnExpedition: "Send the Mr. WHY",
    movementHint:
      "ใช้ปุ่มลูกศรหรือ WASD เพื่อเดิน มือถือให้ลากวงกลมควบคุม กด Shift เพื่อวิ่ง",
    ...
    wiki: "Wiki",
    noWikiLinks: "ยังไม่มีลิงก์ wiki",
    teachMe: "What can you teach me?",
    whereIsThis: "Where am I?",
    askAnything: "อยากถามอะไร?",
    talk: "คุย",
    close: "ปิด",
    thinking: "กำลังคิด...",
    apiKeyMissing: "API key missing",
    ...
    abaoEncounterHint:
      "When you enter Abao’s range, the map opens into a storytelling split scene. Tap the character bubble to talk.",
    hatchEnter: "ฟักและเข้า",
    dispatchPetOnly: "ส่งสัตว์เท่านั้น",
    dispatchArchive: "คลังการส่ง",
    localDispatchRecords: "บันทึกในเครื่อง",
    active: "ทำงาน",
    hibernating: "จำศีล",
    archived: "เก็บแล้ว",
    fieldNotes: "บันทึกภาคสนาม",
    petReturnedNotes: "Your pet returned with {count} field notes.",
    localOnlyNotice:
      "This version stores dispatch records locally. Cross-user sync requires a future server backend.",
    smallCircleEvent:
    ...
    worldResonanceEvent:
      "Peach Blossom Spring briefly becomes a network that answers itself.",
    observerMode: "โหมดดูแบบไม่มีตัวละคร",
    stats: "ค่าสถานะ",
    status: "สถานะ",
    skill: "ทักษะ",
    sendFieldNote: "ฝากบันทึก",
...
export function readStoredLanguage(): LanguageCode {
  try {
    ...
    return raw === "en" || raw === "ja" || raw === "th" || raw === "zh-TW"
      ? raw
      : "zh-TW";
  } catch {
    return "zh-TW";
