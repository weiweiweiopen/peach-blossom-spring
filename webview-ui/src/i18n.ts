...
type TranslationKey =
  ...
  | "projectTitle"
  | "projectIntro"
  | "questionAndLinkLabel"
  | "questionAndLinkPlaceholder"
  | "enterPeachSpring"
  | "dispatchLifeformOnly"
  | "indoorCanopy"
  | "riverCrossing"
  | "peachForest"
  | "bridge"
  ...
  | "greenhouseRoof"
  | "workshopClearing"
  | "mobileDispatchMonitorCollapsed"
  | "openDispatchMonitor"
  | "closeDispatchMonitor"
  | "createProtagonist"
  | "createTraveler"
  | "nameLabel"
  | "namePlaceholder"
...
const translations: TranslationTable = {
  "zh-TW": {
    ...
    projectTitle: "桃花源：可思考的生命模擬器派遣",
    projectIntro:
      "這一個互動寓言維度，許多奇怪生物在這與世隔絕，你來到這裡探索並收集建造一個烏托邦的線索。請自由的與住在這裡的朋友交談，每一個意見裡都有數不盡的寶藏。但記得你的一舉一動都會影響這個自由開源科技藝術世界的發展，或許你會在裡面發現夢境與現實世界耦合的方式。",
    questionAndLinkLabel: "留下一個問題和你的網路連結",
    questionAndLinkPlaceholder:
      "寫下你想交給生命體思考的問題，也可以貼上一個 https:// 連結。",
    enterPeachSpring: "進入桃花源",
    dispatchLifeformOnly: "只派遣生命體",
    indoorCanopy: "室內森林天幕",
    riverCrossing: "河流渡口",
    peachForest: "桃花樹林",
    bridge: "小橋",
    ...
    mountainGate: "山門",
    village: "村落",
    greenhouseRoof: "玻璃溫室屋頂",
    workshopClearing: "工作坊空地",
    mobileDispatchMonitorCollapsed: "派遣紀錄已收合",
    openDispatchMonitor: "打開派遣紀錄",
    closeDispatchMonitor: "收合派遣紀錄",
    ...
    missionLabel: "我想要什麼",
    missionPlaceholder:
      "描述你想讓這個角色帶進桃花源的願望、需求或想共同發展的未來。",
    constraintsLabel: "限制條件（選填）",
    constraintsPlaceholder:
      "例如：不能做成企業 dashboard、預算很小、必須開源、三個月內要有原型。",
    avatarCollection: "置入角色",
    skillsLabel: "我有什麼技能",
    skillsPlaceholder:
      "例如：田野研究、開源硬體、策展、社群組織、織品、寫程式。",
    enterWorld: "進入桃花源",
    sendOnExpedition: "派遣why星人",
    movementHint:
      "用方向鍵或 WASD 行走。手機請在左下角拇指圓圈拖曳移動。按住 Shift 可加速。",
    ...
    expeditionTitle: "桃花源：可思考的生命模擬器派遣",
    templateSimulation: "模板模擬",
    expeditionDescription:
      "把你的任務派進桃花源，讓不同 NPC 從記憶、推演與猜測三種層次互相碰撞。",
  ...
  en: {
    ...
    loginSubtitle:
      "An interactive allegorical dimension of Non-Governmental Matters",
    loginDescription:
      "This is an interactive allegorical dimension. Many strange creatures live here, isolated from the outside world. You arrive to explore and collect clues for building a utopia. Speak freely with the friends who live here; every opinion contains countless treasures. But remember: every move you make will affect the development of this free and open-source world of technological art. Perhaps inside it, you will discover how dreams and the real world can become coupled.",
    projectTitle: "Peach Blossom Spring: Dispatchable Thinking Life Simulator",
    projectIntro:
      "This is an interactive allegorical dimension. Many strange creatures live here, isolated from the outside world. You arrive to explore and collect clues for building a utopia. Speak freely with the friends who live here; every opinion contains countless treasures. But remember: every move you make will affect the development of this free and open-source world of technological art. Perhaps inside it, you will discover how dreams and the real world can become coupled.",
    questionAndLinkLabel: "Leave a question and your web link",
    questionAndLinkPlaceholder:
      "Write the question you want a lifeform to think with, and optionally paste one https:// link.",
    enterPeachSpring: "Enter Peach Blossom Spring",
    dispatchLifeformOnly: "Dispatch Lifeform Only",
    indoorCanopy: "Indoor canopy",
    riverCrossing: "River crossing",
    peachForest: "Peach forest",
    bridge: "Bridge",
    restaurant: "Restaurant / teahouse",
    laboratory: "Open tech laboratory",
    church: "Church",
    temple: "Temple",
    mountainGate: "Mountain gate",
    village: "Village",
    greenhouseRoof: "Greenhouse roof",
    workshopClearing: "Workshop clearing",
    mobileDispatchMonitorCollapsed: "Dispatch monitor collapsed",
    openDispatchMonitor: "Open dispatch monitor",
    closeDispatchMonitor: "Close dispatch monitor",
    ...
    missionPlaceholder:
      "Describe the wish, need, or future you want this avatar to bring into Peach Blossom Spring.",
    constraintsLabel: "Constraints (optional)",
    constraintsPlaceholder:
      "No corporate dashboard, tiny budget, must be open source, prototype in three months...",
    ...
    expeditionTitle:
      "Peach Blossom Spring: Dispatchable Thinking Life Simulator",
    templateSimulation: "Template Simulation",
    expeditionDescription:
      "Dispatch your mission into Peach Blossom Spring and let NPCs collide through memory, extrapolation, and speculation.",
    ...
    abaoEncounterHint:
      "When you enter Abao’s range, the map opens into a storytelling split scene. Tap the character bubble to talk.",
    hatchEnter: "Enter Peach Blossom Spring",
    dispatchPetOnly: "Dispatch Lifeform Only",
    ...
    localOnlyNotice:
      "This version stores dispatch records locally. Cross-user sync requires a future server backend.",
    smallCircleEvent:
      "A small circle of question-pets begins exchanging failed attempts.",
    hibernationEvent:
      "Some question-pets slip into the grass to hibernate, waiting to be recalled.",
    worldResonanceEvent:
      "Peach Blossom Spring briefly becomes a network that answers itself.",
  ...
  th: {
    ...
    loginDescription:
      "Thai localization is not ready yet. The game will currently fall back to English content.",
    projectTitle: "Peach Blossom Spring: Dispatchable Thinking Life Simulator",
    projectIntro:
      "This is an interactive allegorical dimension. Many strange creatures live here, isolated from the outside world. You arrive to explore and collect clues for building a utopia. Speak freely with the friends who live here; every opinion contains countless treasures. But remember: every move you make will affect the development of this free and open-source world of technological art. Perhaps inside it, you will discover how dreams and the real world can become coupled.",
    questionAndLinkLabel: "Leave a question and your web link",
