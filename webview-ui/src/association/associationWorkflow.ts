...
import { buildEditorialBrief, type AssociationEditorialBrief } from "./editorialBrief.js";
import { buildPublicArtifactContent, type AssociationPublicArtifactContent } from "./publicArtifactContent.js";

export interface AssociationWorkflowResult {
  seed: string;
  step1: {
  ...
  step4: {
    outputPlan: AssociationOutputPlan;
    editorialBrief: AssociationEditorialBrief;
    publicArtifact: AssociationPublicArtifactContent;
  };
}

export interface AssociationOutputPlan {
...
export function runAssociationWorkflow(seed: string, corpus: AssociationCorpus): AssociationWorkflowResult {
...
function isReadyForTopicSelection(report: AssociationReport): boolean {
