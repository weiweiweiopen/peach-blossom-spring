...
function renderPbsReset(artifact: AssociationPublicArtifactContent, template: OfficialTemplateSource, language: TemplateLanguage): string {
...
function renderSoftCommons(artifact: AssociationPublicArtifactContent, template: OfficialTemplateSource): string {
  const sections = artifact.sections.slice(0, 7);
...
function renderAinoMotion(artifact: AssociationPublicArtifactContent, template: OfficialTemplateSource, language: TemplateLanguage): string {
  const copy = templateCopy(language);
  const sections = artifact.sections.slice(0, 7);
