...
function topicFromEvidencePool(report: AssociationReport, evidence: SourceCard[]): ResearchTopicCandidate {
...
function riskCaveatFor(pattern: ResearchRelationPattern, cards: SourceCard[], report: AssociationReport): string {
