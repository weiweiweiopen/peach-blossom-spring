...
const checks = [
  ...
  ["NPC suggestions are wiki-guided player questions", /我想知道農業機器人可以用來幹嘛/.test(suggestedQuestionBlock) && /什麼是電子織品/.test(suggestedQuestionBlock) && /柔性電路和電子合成器/.test(suggestedQuestionBlock) && /什麼是多點觸控介面/.test(suggestedQuestionBlock) && /Hackteria 是什麼/.test(suggestedQuestionBlock) && !/你提到|你剛剛|這段談話|共同工作方式|工作坊經驗|玩家想|入口|改寫|\bsource\b|\bsources\b|這個 NPC|你是誰|基本的問題/i.test(npcVisiblePromptCopy)],
