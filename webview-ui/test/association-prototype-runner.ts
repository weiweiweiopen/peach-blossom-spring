...
const outputPath = resolve(testDir, 'output/association-prototype-page.md');
const promptPath = resolve(testDir, 'output/association-llm-prompt.md');
const page = generatePrototypeWikiPage(seed, associationCorpus);
